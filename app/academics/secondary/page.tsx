...
export default function SecondaryPage() {
  ...
  const subjects = [
    ...
    },
    {
      ...
      description: "Advanced Somali literature and composition",
      color: "bg-green-500",
    },
    {
      icon: Calculator,
      name: t("mathematics"),
      description: "Algebra, calculus, statistics, and advanced math",
      color: "bg-purple-500",
    },
    {
      icon: Atom,
    ...
    },
    {
      icon: Microscope,
      name: t("biology"),
      description: "Life sciences, anatomy, and environmental biology",
      color: "bg-emerald-500",
    },
    {
      icon: Globe,
      name: t("geography"),
      description: "World geography, Somali and world history",
      color: "bg-teal-500",
    },
    {
      icon: Moon,
      name: t("arabicLanguage"),
      description: "Advanced Islamic knowledge and Arabic language",
    ...
    },
    {
      ...
      description: "Economics, accounting, and entrepreneurship",
      color: "bg-amber-500",
    },
  ]
